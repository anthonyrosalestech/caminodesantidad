<template>
  <div class="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden items-center justify-center bg-background-light">
    <!-- Navigation -->
    <NavBar />
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <h1 class="text-4xl md:text-6xl font-black text-[#111418] mb-4">
        404
      </h1>
      <h2 class="text-2xl md:text-3xl font-bold text-[#111418] mb-4">
