<template>
  <div class="relative w-full bg-gradient-to-br from-primary/10 via-white to-primary/5 py-8 dark:from-primary/20 dark:via-[#111418] dark:to-primary/10 md:py-12">
      ...
      <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="flex-1">
          ...
          <div class="mb-4 flex items-center gap-2">
            <span class="inline-flex items-center gap-1 rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary dark:bg-primary/20">
          ...
          <Card padding="lg" class="sticky top-4 shadow-xl">
            <div class="space-y-4">
              ...
              <div class="border-t border-gray-200 pt-4 dark:border-gray-700">
                <p class="mb-3 font-semibold text-[#111418] dark:text-white">
                  Este curso incluye:
                </p>
