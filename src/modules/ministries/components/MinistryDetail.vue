      ...
      >
        ...
        >
          <div
            v-if="isOpen && ministry"
            @click.stop
            class="relative w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-t-2xl bg-white shadow-2xl sm:rounded-2xl"
          >
            <!-- Close Button -->
            <button
              @click="handleClose"
              class="absolute right-4 top-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-white/90 text-gray-600 shadow-lg backdrop-blur-sm transition-all hover:bg-white hover:text-gray-900"
              aria-label="Cerrar"
            >
            ...
            <div class="max-h-[90vh] overflow-y-auto">
              <!-- Header Image -->
              <div class="relative h-48 w-full overflow-hidden bg-gray-200 md:h-64">
                <img
                  :src="ministry.image"
                  :alt="ministry.name"
                ...
                <!-- Icon Badge -->
                <div class="absolute bottom-4 left-4 flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-xl md:h-20 md:w-20">
              ...
              <div class="p-6 md:p-8">
                ...
                <div class="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <h2 class="text-2xl font-bold text-[#111418] md:text-3xl">
                    {{ ministry.name }}
                  </h2>
                  <span v-if="ministry.ageRange" class="inline-flex items-center gap-2 self-start rounded-full bg-primary/10 px-4 py-2 text-sm font-medium text-primary">
                ...
                <!-- Description -->
                <div class="mb-8">
                  <h3 class="mb-3 text-lg font-semibold text-[#111418]">
                ...
                <div class="mb-8 rounded-lg bg-gray-50 p-6">
                  <h3 class="mb-4 text-lg font-semibold text-[#111418]">
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                      <p class="font-semibold text-[#111418]">
                ...
                <div v-if="ministry.schedule && ministry.schedule.length > 0" class="mb-8">
                  ...
                  <div class="space-y-3">
                    ...
                    >
                      ...
                      <div class="flex-1">
                        <p class="font-medium text-[#111418]">
                          {{ schedule.activity }}
                        </p>
                ...
                <div v-if="ministry.activities && ministry.activities.length > 0" class="mb-8">
                  ...
                  <ul class="grid gap-3 sm:grid-cols-2">
                    ...
                    >
                      <MaterialIcon name="check_circle" class-name="mt-0.5 text-lg text-green-600" />
